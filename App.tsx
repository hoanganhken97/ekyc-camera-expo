...
const instructionsText = {
  initialPrompt: 'Để khuôn mặt của bạn trong vòng tròn',
  performActions: 'Giữ yên thiết bị và thực hiện các hành động sau:',
  tooClose: 'Bạn ở quá gần. Giữ thiết bị xa hơn.',
};

const detections = {
  BLINK: {instruction: 'Chớp chớp cả hai mắt', minProbability: 0.3},
  TURN_HEAD_LEFT: {instruction: 'Quay đầu sang trái', maxAngle: -15},
  TURN_HEAD_RIGHT: {instruction: 'Quay đầu sang phải', minAngle: 15},
  NOD: {instruction: 'Cúi xuống', minDiff: 1.5},
